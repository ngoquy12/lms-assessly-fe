...
import { buildBrief, citationSubset, inferFrameworkPlaybook, inferPlaybook, resolveFiles } from "../lib/investigation-brief.mjs";
...
function buildManifest(merged, investigation) {
    ...
    return {
        ...
        preResolvedRecords: Array.isArray(investigation.preResolvedRecords) ? investigation.preResolvedRecords : [],
