...
export function gate(signals) {
    ...
    const fluidEnabled = signals.project?.resourceConfig?.fluid === true || signals.project?.defaultResourceConfig?.fluid === true;
    ...
    return [
        {
            ...
            reason: cold.length > 0 ? "cold starts observed and Fluid Compute is disabled" : "slow hot routes and Fluid Compute is disabled",
