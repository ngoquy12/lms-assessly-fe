...
export const SCANNER_GATES = [
    { id: "image_optimization", patterns: ["unoptimized-image"], threshold: 2, billingDimension: "image-optimization", priority: 30 },
    { id: "cache_header_gap", patterns: ["max-age-without-s-maxage", "missing-cache-headers"], threshold: 1, billingDimension: "edge-requests", priority: 40 },
    { id: "rendering_candidate", patterns: ["force-dynamic", "headers-in-page"], threshold: 3, billingDimension: "function-duration", priority: 35 },
    { id: "use_cache_date_stamp", patterns: ["use-cache-date-stamp"], threshold: 1, billingDimension: "isr", priority: 45 },
    {
...
function candidateForGroup(cfg, group) {
    ...
    return {
        ...
        confidence: 0.88,
        o11ySignal: matched.map((m) => m.o11ySignal).find((s) => s && s !== "COLD-PATH" && s !== "NO-ROUTE-MAPPING") ?? "scanner-only",
