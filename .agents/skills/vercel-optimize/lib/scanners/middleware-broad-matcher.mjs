export const metadata = {
    ...
    citations: ["https://nextjs.org/docs/app/building-your-application/routing/middleware"],
...
export function scan({ files }) {
    ...
    for (const { path, content } of files) {
        ...
        const exportsMiddleware = /export\s+(default\s+)?(async\s+)?function\s+middleware/.test(content) || /export\s+const\s+middleware\s*=/.test(content);
