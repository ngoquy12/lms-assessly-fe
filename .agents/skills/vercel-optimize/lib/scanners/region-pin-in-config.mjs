...
export const metadata = {
    ...
    citations: ["https://vercel.com/docs/functions/configuring-functions/region", "https://vercel.com/docs/functions/configuring-functions/region"],
    excludeGlobs: ["node_modules/**", ".next/**", "dist/**"],
    includeGlobs: ["vercel.json", "**/vercel.json", "**/page.{ts,tsx,js,jsx}", "**/route.{ts,tsx,js,jsx}", "**/layout.{ts,tsx,js,jsx}"],
};
