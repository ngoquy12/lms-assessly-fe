    ...
    return (
        <div className="min-h-screen w-full bg-slate-50 font-sans text-slate-900">
            <div className="mx-auto max-w-[1440px] space-y-8 px-6 py-8 sm:px-10">
                ...
                {/* 1. Header Banner */}
                <div className="rounded-3xl bg-linear-to-r from-brand-600 via-brand-700 to-slate-900 p-8 text-white shadow-lg">
                ...
                <QueryStateBoundary isLoading={isLoading} isError={isError} onRetry={refetch}>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        >
                            ...
                            <p className="mt-2 text-xl font-extrabold text-brand-700">{leaderboard[1]?.totalScore} pts</p>
                        </Card>
                        ...
                        >
                            ...
                            <p className="mt-2 text-2xl font-extrabold text-brand-700">{leaderboard[0]?.totalScore} pts</p>
                        </Card>
                        ...
                        <Card size="sm" className="relative order-3 overflow-hidden rounded-2xl border-amber-200/80 bg-white p-6 text-center shadow-xs">
                            ...
                            <p className="mt-2 text-xl font-extrabold text-brand-700">{leaderboard[2]?.totalScore} pts</p>
                        </Card>
                    </div>
                    ...
                    <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-xs">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse text-left">
                                <thead>
                                    <tr className="border-b border-brand-100 bg-brand-50/70 text-brand-700">
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {leaderboard.map((item) => (
                                        <tr key={item.id} className="transition-colors hover:bg-slate-50/70">
                                            ...
                                            <td className="px-6 py-4 text-right text-base font-extrabold text-brand-700">{item.totalScore}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
