...
import { MOCK_LEADERBOARD } from "@/mocks/user.mock";
        ...
        <div className="min-h-screen w-full bg-[#f8fafc] px-4 py-10 font-sans text-slate-900 sm:px-8 lg:px-12">
            <div className="mx-auto max-w-[1440px] space-y-8">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    {/* Top 2 */}
                    <Card size="sm" className="relative order-2 overflow-hidden rounded-2xl border-slate-200/80 bg-white p-6 text-center shadow-xs sm:order-1">
