...
import { useInterviewPositions } from "@/hooks/queries/use-interview";

export function InterviewListView() {
    const { data, isLoading, isError, refetch } = useInterviewPositions();
                            ...
                            >
                                ...
                                <CardContent className="space-y-4 pt-0">
                                    ...
                                    <Link href={`/ai-interview/check-device/${pos.id}`} className="block">
                                        <Button
                                            className="h-11 w-full gap-2 rounded-xl bg-[#ab1f24] font-bold text-white shadow-xs hover:bg-[#90171b]"
                                            size="md"
                                        >
